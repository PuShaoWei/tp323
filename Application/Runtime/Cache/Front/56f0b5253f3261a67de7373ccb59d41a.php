...
<head>
	...
	<link rel="stylesheet" href="/Public/Front/style/list.css" type="text/css">
	...
	<script type="text/javascript" src="/Public/Front/js/list.js"></script>
</head>
<body>
	<!-- 顶部导航 start -->
<body>
...
<!-- 头部 start -->
	...
	<div class="list w1210 bc mt10">
		...
		<div class="breadcrumb">
			<h2 id="category">当前位置：<a href="">首页</a> > <a href="">电脑、办公</a></h2>
		</div>
		<!-- 面包屑导航 end -->
			...
			<div class="newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/Public/Front/images/list_hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/Public/Front/images/list_hot2.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="/Public/Front/images/list_hot3.jpg" alt="" /></a></dt>
	...
	<a name="search_position">
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="list_top">
				...
				<div class="hotsale fl">
					...
					<ul>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/Public/Front/images/acer4739.jpg" alt="" /></a></dt>
			...
			.condition:hover{	text-decoration:none;	}
			._condition:hover{
				background: #fff;
				color: red;
				text-decoration:none;	
			...
			<div style="clear:both;"></div>
			<?php if(I('get.price')):?>
			<p style="margin-top:10px ">当前搜索条件：<a class="condition" href="#search_position"> <?=I('get.price')?> <a class="_condition" href="<?=U('search?cid='.I('get.cid'));?>#search_position">X</a></a></p>
			<?php endif;?>
			<!-- 商品筛选 start -->
			<div class="filter mt10">
				...
				<div class="filter_wrap">
					...
					<dl>
						<dt>价格：</dt>
						<?php foreach($price['price'] as $v):?>
						<dd><a href="<?=U('search?cid='.I('get.cid').'&price='.$v);?>#search_position"><?=$v;?></a></dd>
						<?php endforeach;?>
					</dl>
			...
			<div class="goodslist mt10">
				<ul>
					<li>
						<dl>
							<dt><a href=""><img src="/Public/Front/images/goods1.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="/Public/Front/images/goods2.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="/Public/Front/images/goods3.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="/Public/Front/images/goods4.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="/Public/Front/images/goods5.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="/Public/Front/images/goods6.jpg" alt="" /></a></dt>
