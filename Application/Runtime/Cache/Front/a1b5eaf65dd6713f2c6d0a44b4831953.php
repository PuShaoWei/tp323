...
<head>
	...
	<script type="text/javascript" src="/Public/Front/js//index.js"></script>
	<style type="text/css">
...
<!-- 头部 start -->
	<div class="header w1210 bc mt15">
		...
		<div class="nav w1210 bc mt10">
			<!--  商品分类部分 start-->
			<div class="category fl <?php if(1 != 1): ?>cat1<?php endif; ?>"> <!-- 非首页，需要添加cat1类 -->
				<div class="cat_hd <?php if(1 != 1): ?>off<?php endif; ?>">  <!-- 注意，首页在此div上只需要添加cat_hd类，非首页，默认收缩分类时添加上off类，鼠标滑过时展开菜单则将off类换成on类 -->
					<h2>全部商品分类</h2>
					<em></em>
				</div>				
				<div class="cat_bd <?php if(1 != 1): ?>none<?php endif; ?>">
	...
	<div class="colligate w1210 bc mt10">
		...
		<div class="slide fl">
			<div class="area">
				<div class="slide_items">
					<ul>
						<li><a href=""><img src="/Public/Front/images//index_slide1.jpg" alt="" /></a></li>
						<li><a href=""><img src="/Public/Front/images//index_slide2.jpg" alt="" /></a></li>
						<li><a href=""><img src="/Public/Front/images//index_slide3.jpg" alt="" /></a></li>
						<li><a href=""><img src="/Public/Front/images//index_slide4.jpg" alt="" /></a></li>
						<li><a href=""><img src="/Public/Front/images//index_slide5.jpg" alt="" /></a></li>
						<li><a href=""><img src="/Public/Front/images//index_slide6.jpg" alt="" /></a></li>
					</ul>
				</div>
		...
		<div class="coll_right fl ml10">
			<div class="ad"><a href=""><img src="/Public/Front/images//ad.jpg" alt="" /></a></div>
			...
			<div class="service mt10">
				...
				<div class="service_wrap">
					...
					<div class="travel none">
						<ul>
							<li>
								<a href=""><img src="/Public/Front/images//holiday.jpg" alt="" /></a>
								<a href="" class="button">度假查询</a>
							</li>
							<li>
								<a href=""><img src="/Public/Front/images//scenic.jpg" alt="" /></a>
					...
					<div class="lottery none">
						<p><img src="/Public/Front/images//lottery.jpg" alt="" /></p>
					</div>
					<!-- 彩票 end -->
					...
					<div class="game none">
						<ul>
							<li><a href=""><img src="/Public/Front/images//sanguo.jpg" alt="" /></a></li>
							<li><a href=""><img src="/Public/Front/images//taohua.jpg" alt="" /></a></li>
							<li><a href=""><img src="/Public/Front/images//wulin.jpg" alt="" /></a></li>
						</ul>
					</div>
					<!-- 游戏 end -->
				</div>
	...
	<div class="guide w1210 bc mt15">
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					...
					<?php foreach($goods1 as $v):?>
						<li>
							<dl>
								<dt><a href="<?=U('goods?id='.$v['id'])?>"><img src="<?=IMG.$v['mid_logo']?>" alt="" /></a></dt>
								<dd><a href="<?=U('goods?id='.$v['id'])?>"><?=$v['goods_name']?></a></dd>
								<dd><span>售价：</span><strong> ￥<?=$v['promote_price']?></strong></dd>
							</dl>
						</li>
					<?php endforeach;?>
					</ul>	
				...
				<div class="guess none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="/Public/Front/images//guess1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/Public/Front/images//guess2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="/Public/Front/images//guess3.jpg" alt="" /></a></dt>
		...
		<div class="sidebar fl ml10">
			...
			<div class="sidebar_wrap">
				<dl class="first">
					<dt class="fl"><a href=""><img src="/Public/Front/images//viewsonic.jpg" alt="" /></a></dt>
				...
				<dl>
					<dt class="fr"><a href=""><img src="/Public/Front/images//samsung.jpg" alt="" /></a></dt>
	...
	<div class="floor1 floor w1210 bc mt10">
		...
		<div class="floor_left fl">
			...
			<div class="cate fl">
				...
				<div class="cate_wrap">
					...
					<p><a href=""><img src="/Public/Front/images//notebook.jpg" alt="" /></a></p>
				</div>
			...
			<div class="goodslist fl">
				<h2>
					<?php foreach($v['recChildren'] as $k2=>$v2):?>
					<span <?php if($k2==0) echo' class="on"'?>><?=$v2['cat_name']?></span>
					<?php  endforeach;?>	
				</h2>
				<div class="goodslist_wrap">
				<?php foreach($v['recChildren'] as $k3=>$v3):?>
					<div <?php if($k3>0) echo 'class="none"';?>>
						<ul>
							<?php foreach($v3 ['goods'] as $k4=>$v4):?>
							<li>
								<dl>
									<dt><a title="<?=$v4['goods_name']?>" href="<?=U('goods?id='.$v2['id'])?>"><img src="<?=IMG.$v4['mid_logo']?>" alt="" /></a></dt>
									<dd style=" "><a title="<?=$v4['goods_name']?>"  href="<?=U('goods?id='.$v2['id'])?>"><?=$v4['goods_name']?></a></dd>
									<dd><span>售价：</span> <strong>￥<?=$v4['shop_price']?></strong></dd>
								</dl>
							</li>
						<?php endforeach;?>
						</ul>
		...
		<div class="sidebar fl ml10">
			...
			<div class="brand">
				...
				<div class="sidebar_wrap">
					<ul>
						<li><a href=""><img src="/Public/Front/images//dell.gif" alt="" /></a></li>
						<li><a href=""><img src="/Public/Front/images//acer.gif" alt="" /></a></li>
						<li><a href=""><img src="/Public/Front/images//fujitsu.jpg" alt="" /></a></li>
						<li><a href=""><img src="/Public/Front/images//hp.jpg" alt="" /></a></li>
						<li><a href=""><img src="/Public/Front/images//lenove.jpg" alt="" /></a></li>
						<li><a href=""><img src="/Public/Front/images//samsung.gif" alt="" /></a></li>
						<li><a href=""><img src="/Public/Front/images//dlink.gif" alt="" /></a></li>
						<li><a href=""><img src="/Public/Front/images//seagate.jpg" alt="" /></a></li>
						<li><a href=""><img src="/Public/Front/images//intel.jpg" alt="" /></a></li>
					</ul>
				</div>
			</div>
			<!-- 品牌旗舰店 end -->
			...
			<!-- 广告 start -->
			<div class="ads mt10">
				<a href=""><img src="/Public/Front/images//canon.jpg" alt="" /></a>
			</div>
			<!-- 广告 end -->
		</div>
		<!-- 右侧 end -->
