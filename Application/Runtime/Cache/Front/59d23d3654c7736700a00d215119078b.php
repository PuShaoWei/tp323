...
<head>
	...
	<link rel="stylesheet" href="/Public/Front/style/login.css" type="text/css">
...
$.ajax({
	...
	<div class="header w990 bc mt15">
		<div class="logo w990">
			<h2 class="fl"><a href="index.html"><img src="/Public/Front/images/logo.png" alt="京西商城"></a></h2>
		</div>
	</div>
	<!-- 页面头部 end -->
			...
			<div class="login_form fl">
				<form action="" method="post">
					<ul>
						<li>
							<label for="">用户名：</label>
							<input type="text" class="txt" name="account" />
						</li>
						<li>
							<label for="">密码：</label>
						...
						<li class="checkcode">
							...
							<img   onclick="this.src='<?=U('captcha')?>?'+Math.random();" src="<?=U('captcha')?>" alt=""/>
