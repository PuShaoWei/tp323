        ...
        <table width="100%" id="general-table">
            ...
            <tr>
                <td class="label">是否楼层:</td>
                    <td>
                        <input type='radio' name='is_show' maxlength="20" value='y'    > 是
                        <input type='radio' name='is_show' maxlength="20" value='n'  checked> 否
                    </td>
            </tr>   
            <tr>
                <td class="label">分类名称:</td>
                    <td>
                        <input type='text' name='cat_name' maxlength="20" value='' > <font color="red">*</font>
                    </td>
            </tr>              
            <tr>
                <td class="label">排序字段:</td>
                    <td>
                        <input type='text' name='sort_num' maxlength="20" value='100' > <font color="red">*</font>
                    </td>
            </tr>        
        </table>
