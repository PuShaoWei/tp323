      ...
      <div class="login_form">
        <form name="loginform" accept-charset="utf-8" id="login_form" class="loginForm" method="post">
                <div class="uinArea" id="uinArea">
                    <label class="input-tips" for="u" style="width:70px;">帐　号：</label>
                ...
                <div class="pwdArea" id="pwdArea">
                    <label class="input-tips" for="p" style="width:70px;">密　码：</label> 
                ...
                <div class="pwdArea" id="pwdArea">
                    <label class="input-tips" for="captcha" style="width:70px;">验证码：</label> 
                    <div class="inputOuter">
                        <input style="width:80px;" id="captcha"  name="captcha" class="inputstyle"/>
                    </div>
                </div>
                <img style="cursor: pointer; " onclick="this.src='<?=U('Login/captcha')?>?'+Math.random();" src="<?=U('Login/captcha')?>">
