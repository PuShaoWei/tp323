            ...
            <tr>
             ...
             <tr>
                <td class="label">是否楼层:</td>
                    <td>
                        <input type='radio' name='is_show' maxlength="20" value="y" <?php if($former['is_show']=='y') echo checked ?>> 是
                        <input type='radio' name='is_show' maxlength="20" value="n" <?php if($former['is_show']=='n') echo checked ?>> 否
                    </td>
            </tr>   
            <tr>
                <td class="label">分类名称:</td>
                    <td>
                        <input type='text' name='cat_name' maxlength="20" value="<?=$former['cat_name'];?>" > <font color="red">*</font>
                    </td>
            </tr>            
            <tr>
