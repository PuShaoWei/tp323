        ...
        <table width="100%" id="general-table">
            <tr>
                <td class="label">品牌logo:</td>
                    <td>
                        <input type='file' name='logo' maxlength="20"  > 
                    </td>
                        <img style="width: 100px;height: 100px; margin: 0 auto;" src="<?=IMG.$data['logo']?>">
            </tr>
            <tr>
                <td class="label">品牌名称:</td>
                    <td>
                        <input type='text' name='brand_name' maxlength="20" value="<?=$data['brand_name'];?>" >   <font color="red">*</font>
                    </td>
            </tr>
                 <tr>
                <td class="label">品牌地址:</td>
                    <td>
                        <input type='text' name='site' maxlength="20" value="<?=$data['site'];?>"><font color="red">*</font>
                    </td>
            </tr> 
        </table>
