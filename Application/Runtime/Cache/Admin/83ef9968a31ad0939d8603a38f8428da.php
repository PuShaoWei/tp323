        ...
        <table width="100%" id="general-table">
            ...
            <tr>
                <td class="label">属性内容:</td>
                    <td>
                    <textarea cols="50" rows="10"  name="attr_values"> </textarea>
                    </td>
            </tr> 
            ...
            <tr>
                <td class="label">属性可选值:</td>
                    <td>
                        <input type='radio' name='attr_type' maxlength="20" value='唯一' checked >唯一
                        <input type='radio' name='attr_type' maxlength="20" value='可选' >可选
                         <font color="red">*</font>
                    </td>
            </tr>            
            <tr>
