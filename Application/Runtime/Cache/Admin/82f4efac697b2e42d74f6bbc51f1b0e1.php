        ...
        <table width="100%" id="general-table">
            ...
            <tr>  
                <td class="label">角色:</td>
                 ...
                 <input name="r_id[]" type="checkbox" value="<?=$v['id'];?>" > <?=$v['role_name']?>
            ...
            <tr>
                <td class="label">账号:</td>
                    <td>
                        <input type='text' name='account' maxlength="20" value='' > <font color="red">*</font>
                    </td>
            </tr>
            <tr>
                <td class="label">密码:</td>
                    <td>
                        <input type='password' name='password' maxlength="20" value='' > <font color="red">*</font>
                    </td>
            </tr>
            <tr>
                <td class="label">确认密码:</td>
                    <td>
                        <input type='password' name='cpassword' maxlength="20" value='' > <font color="red">*</font>
                    </td>
            </tr>
