...
<body>
<h1>
    <span class="action-span"><a href="<?=U('add') ?>">添加新品牌</a></span>
...
<div class="form-div">
    <form action="" name="searchForm">
        ...
        <!-- 关键字 -->
        品牌名称 <input type="text" name="rn" size="25" value="<?=I('get.rn')?>" />
    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
          ...
          <?php foreach($data as $k=>$v): $v['num']=$num++; ?>
            <tr>
                <td><?=$v['id'];?></td>
                <td  class="first-cell"align="center"><span><?=$v['brand_name']?></span></td>          
            <td align="center"><img style="width: 100px;height: 100px; " src="<?=IMG.$v['logo'];?>"></td>
